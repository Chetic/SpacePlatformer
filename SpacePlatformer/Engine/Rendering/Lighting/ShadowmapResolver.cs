...
namespace SpacePlatformer.Engine.Rendering
{
    ...
    class ShadowmapResolver
    {
        ...
        {
            reductionEffect = GameplayScreen.content.Load<Effect>("Shaders\\Lighting\\reductionEffect");
            resolveShadowsEffect = GameplayScreen.content.Load<Effect>("Shaders\\Lighting\\resolveShadowsEffect");
